    ...
    <div className='main-banner'>
      <div className='main-banner-title'>
        <div className='main-banner-title-top'>
          ...
          >
            Communicate <div className='sm-break'/> Together,
          </motion.div>
          <motion.div 
          ...
          >
            Code with <div className='sm-break'/> Ease
          </motion.div>
        </div>
        <motion.div 
      ...
      <div className='section1'>
        <div className='section1-top'>
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            MINJE는 코드 작성에 그치지 않고,<br/>
            소통을 통해 더 나은 결과를 만듭니다. 
          </motion.div>
        </div>
        ...
        <div className='section2-content'>
          <div className='section2-content-top'>
            ...
            <motion.div
              ...
              transition={{ duration: 1 }}
            >
              기술과 소통으로 <div className='sm-break'/> 팀을 잇는 개발자 <br/>
              <span>구민제</span>입니다.
            </motion.div>
          </div>
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <div className='tag'> # 견고한 로직 </div>
            <div className='tag'> # 소통하는 작업 </div>
          </motion.div>
          <motion.div
        ...
        <div className='section3-content'>
          ...
          <div className='contents'>
            <div className='item'>
              ...
              <div>
                한국외국어대학교 <br/> 
                컴퓨터전자시스템공학부 학사 졸업 예정 <div className='sm-break'> </div> [학점 : 3.92]
              </div>
            </div>
          </div>
        </div>
    ...
    <div className='section6-wrap'>
      <div className='section6'>
        ...
        >
          ...
          <div>소통은 늘 함께,  <div className='sm-break'> </div> 코딩은 편안하게</div>
        </motion.div>
        <motion.div 
          ...
          transition={{ duration: 1}}
        >
          <a rel="noopener noreferrer" href='https://open.kakao.com/o/soqV6oLh' target='_blank'>
  ...
  return (
    <div className='footer'>
      ...
      <div className='footer-right'>
        Tel :  010-3924-0134 <br/>
        Email : koo4802@gmail.com <br/>
        Copyright 2025. MINJE. All rights reserved.
      </div>
    </div>
  )
}
